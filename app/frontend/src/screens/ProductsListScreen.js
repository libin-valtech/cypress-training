...
const ProductsListScreen = ({ history, match }) => {
  ...
  return (
    <>
      <Helmet>
      <title>Product list</title>      </Helmet>
      <Row className='align-items-center'>
        <Col>
        <h1 style={{ color: '#AAAAAA' }}>Product list</h1>        </Col>
        <Col className='text-left'>
          <Button className='my-3 btn btn-brand' onClick={createProductHandler}>
          <i className='fas fa-plus'></i> Adding a product          </Button>
        </Col>
      </Row>
      {loading || loadingCreate ? (
        <Spinner />
        ...
        <>
          ...
          {success && (
            <Message
              ...
              classN='alert-product-screen'
            >
The product has been updated successfully            </Message>
          )}
            ...
            <>
              ...
              >
                ...
                <tr style={{ textAlign: 'center' }}>
                     ...
                     <th>price</th>
                     <th style={{ width: '6rem' }}>Quantity in stock</th>
                     <th className='hide-sm hide-md'>category</th>
                     <th className='hide-sm hide-md'>manufacturer</th>
                     <th>famous</th>
