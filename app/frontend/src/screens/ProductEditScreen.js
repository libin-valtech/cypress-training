...
const ProductEditScreen = ({ match, history }) => {
  ...
  return (
    <>
      <Helmet>
        <title>Product editing{!product ? '' : `"${product.name}"`} </title>
      </Helmet>
      ...
      {loadingUpdate ? (
        ...
        <>
          <FormContainer md={8}>
            <ListGroup>
              <ListGroup.Item>
              <h1 className='text-center'>Edit Product</h1>              </ListGroup.Item>
              ...
              <ListGroup.Item>
                <Form onSubmit={submitHandler}>
                  ...
                  <Form.Label>The image path</Form.Label>                    <Form.Control
                      dir='ltr'
                      type='text'
                      placeholder='URL'
                    ...
                    {uploading ? (
                      ...
                      <>
<Form.Label className='mt-3'>or image upload</Form.Label>                        <Form.File
                          className='mb-1'
                          id='image-file'
